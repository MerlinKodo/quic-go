...
// Source: github.com/MerlinKodo/quic-go/http3 (interfaces: QUICEarlyListener)
//
// Generated by this command:
//
//	mockgen -package http3 -destination mock_quic_early_listener_test.go github.com/MerlinKodo/quic-go/http3 QUICEarlyListener
//
