...
// Source: github.com/MerlinKodo/quic-go (interfaces: Stream)
//
// Generated by this command:
//
//	mockgen -build_flags=-tags=gomock -package mockquic -destination quic/stream.go github.com/MerlinKodo/quic-go Stream
//
