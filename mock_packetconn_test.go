...
//
//	mockgen -package quic -self_package github.com/MerlinKodo/quic-go -self_package github.com/MerlinKodo/quic-go -destination mock_packetconn_test.go net PacketConn
//
